---
id: TASK-007
title: Sentence eligibility classification — batch 3 (s2101–s3150)
assignee: gemini-flash
status: ready
branch: task/007-eligibility-batch-3
depends_on: [TASK-004]
verify:
...
Classify sentence rows `s2101`–`s3150` from `sentences_core.js` into the
