...
const sentencesPlanV2Path = path.join(root, "sentences_lesson_plan_v2.js");
...
// 5. Build v1 snapshot
// Let's load the legacy sentences_lesson_plan.js verbatim to extract the snapshot
const legacyLessons = loadBrowserJS(path.join(root, "sentences_lesson_plan.js"), "HANAPATH_SENTENCE_LESSONS");
...
console.log("Wrote sentences_lesson_plan_v2.js");
