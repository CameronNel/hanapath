...
function auditBrowserWiring() {
  ...
  const appRef = index.indexOf("./app.js?v=20260729b");
  ...
  assert.match(sw, /hanapath-shell-v454/);
  assert.match(sw, /\.\/exam_integrity\.js\?v=20260721b/);
  assert.match(sw, /\.\/app\.js\?v=20260729b/);
  ...
  assert.match(app, /const EXAM_INTEGRITY_APP_VERSION = "hanapath-shell-v454"/);
  assert.match(app, /const EXAM_INTEGRITY_ASSET_REVISION = "20260729b"/);
