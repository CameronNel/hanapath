...
function auditBrowserWiring() {
  ...
  const appRef = index.indexOf("./app.js?v=20260729c");
  ...
  assert.match(sw, /hanapath-shell-v455/);
  assert.match(sw, /\.\/exam_integrity\.js\?v=20260721b/);
  assert.match(sw, /\.\/app\.js\?v=20260729c/);
  ...
  assert.match(app, /const EXAM_INTEGRITY_APP_VERSION = "hanapath-shell-v455"/);
  assert.match(app, /const EXAM_INTEGRITY_ASSET_REVISION = "20260729c"/);
