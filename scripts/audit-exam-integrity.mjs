...
function auditBrowserWiring() {
  ...
  const appRef = index.indexOf("./app.js?v=20260810e");
  ...
  assert.match(sw, /hanapath-shell-v462/);
  assert.match(sw, /\.\/exam_integrity\.js\?v=20260810c/);
  assert.match(sw, /\.\/app\.js\?v=20260810e/);
  ...
  assert.match(app, /const EXAM_INTEGRITY_APP_VERSION = "hanapath-shell-v462"/);
  assert.match(app, /const EXAM_INTEGRITY_ASSET_REVISION = "20260810e"/);
