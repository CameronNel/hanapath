...
function auditBrowserWiring() {
  ...
  const appRef = index.indexOf("./app.js?v=20260726b");
  ...
  assert.match(app, /const EXAM_INTEGRITY_APP_VERSION = "hanapath-shell-v451"/);
  assert.match(app, /const EXAM_INTEGRITY_ASSET_REVISION = "20260726b"/);
