...
function auditBrowserWiring() {
  ...
  const appRef = index.indexOf("./app.js?v=20260726a");
  ...
  assert.match(sw, /hanapath-shell-v450/);
  ...
  assert.match(app, /const EXAM_INTEGRITY_APP_VERSION = "hanapath-shell-v450"/);
  assert.match(app, /const EXAM_INTEGRITY_ASSET_REVISION = "20260726a"/);
