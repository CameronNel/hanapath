...
function auditBrowserWiring() {
  ...
  const appRef = index.indexOf("./app.js?v=20260812b");
  ...
  assert.match(sw, /hanapath-shell-v468/);
  assert.match(sw, /\.\/exam_integrity\.js\?v=20260810c/);
  assert.match(sw, /\.\/app\.js\?v=20260812b/);
  ...
  assert.match(app, /const EXAM_INTEGRITY_APP_VERSION = "hanapath-shell-v468"/);
  assert.match(app, /const EXAM_INTEGRITY_ASSET_REVISION = "20260812b"/);
