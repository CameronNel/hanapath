...
function auditBrowserWiring() {
  ...
  const appRef = index.indexOf("./app.js?v=20260810f");
  ...
  assert.match(app, /const EXAM_INTEGRITY_APP_VERSION = "hanapath-shell-v463"/);
  assert.match(app, /const EXAM_INTEGRITY_ASSET_REVISION = "20260810f"/);
