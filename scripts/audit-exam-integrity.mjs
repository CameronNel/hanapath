...
function auditBrowserWiring() {
  ...
  const integrityRef = index.indexOf("./exam_integrity.js?v=20260810c");
  const appRef = index.indexOf("./app.js?v=20260811c");
  ...
  assert.match(sw, /hanapath-shell-v466/);
  assert.match(sw, /\.\/exam_integrity\.js\?v=20260810c/);
  assert.match(sw, /\.\/app\.js\?v=20260811c/);
  ...
  assert.match(app, /const EXAM_INTEGRITY_APP_VERSION = "hanapath-shell-v466"/);
  assert.match(app, /const EXAM_INTEGRITY_ASSET_REVISION = "20260811c"/);
