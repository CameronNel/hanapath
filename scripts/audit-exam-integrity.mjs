...
function auditBrowserWiring() {
  ...
  const appRef = index.indexOf("./app.js?v=20260812a");
  ...
  assert.match(sw, /hanapath-shell-v467/);
  assert.match(sw, /\.\/exam_integrity\.js\?v=20260810c/);
  assert.match(sw, /\.\/app\.js\?v=20260812a/);
  ...
  assert.match(app, /const EXAM_INTEGRITY_APP_VERSION = "hanapath-shell-v467"/);
  assert.match(app, /const EXAM_INTEGRITY_ASSET_REVISION = "20260812a"/);
