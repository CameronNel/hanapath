...
- **Words finalization is closed** — the authoritative historical checklist is **teaching spec §9**, and the batch-by-batch execution record is [`docs/WORDS_FINAL_ROADMAP.md`](docs/WORDS_FINAL_ROADMAP.md). Summary:
