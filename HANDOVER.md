...
- **What remains to finalize the Words section** — the authoritative, ordered checklist is **teaching spec §9**. Summary:
  1. **M2 sense split** — only **12 lemmas** have genuine multi-sense rows (쓰다, 시장, 배, 말, 타다, 내리다, 일어나다, 것, 하다, 보다, 나다, `(으)ㄴ`). Real authoring work on the high-frequency polyseme list in spec §9.
