...
- **What remains to finalize the Words section** — the authoritative, ordered checklist is **teaching spec §9**. Summary:
  1. **M2 sense split** — done (Track B is checked off in the roadmap); 98 lemmas are genuinely split, 18 singleton senseKeys remain for Track C, and `피다` is declined in writing.
