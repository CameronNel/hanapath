...
- **Shipped: Track A (bank foundation, PR #98), Sentence Studio, and Tracks B/C/D/E/F/G/I/J1/J2 (2026-07-06 → 08).** Current main tip includes PR #149 and subsequent updates; cache version `v259` / `app.js?v=20260708e`. Live per-sentence facts: bank **2,060 rows**, `band` explicit on all 2,060, `patternTags` explicit on all 2,060.
