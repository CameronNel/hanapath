// [2026-07-22] Cache bumped for Words C1 s3-grammar-u2-l3 authored typed-production items.
const CACHE_NAME = "hanapath-shell-v442";
...
const APP_SHELL = [
  ...
  "./words_lesson_plan.js?v=20260722d",
  ...
  "./form_check_blueprints.js?v=20260722d",
  "./app.js?v=20260722d",
