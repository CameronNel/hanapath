// [2026-08-12] Refresh the offline privacy policy for the Android AdMob release.
const CACHE_NAME = "hanapath-shell-v467";
...
const APP_SHELL = [
  ...
  "./hangul_mastery_scoring_policy.js?v=20260810f",
