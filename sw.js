// [2026-07-22] Cache bumped for Words C1 authored-production review fixes.
const CACHE_NAME = "hanapath-shell-v443";
...
const APP_SHELL = [
  ...
  "./words_lesson_plan.js?v=20260722e",
