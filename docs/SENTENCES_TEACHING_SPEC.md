...
| 7 | Pattern-tag curation (inferred → explicit) | ✅ **done** — 2,060 rows explicit; **accuracy sweep complete for s0001–s2000** (s0401–s1600 gap closed 2026-07-07). Tail rows s2001–s2060 were curated fresh in Track D (D8) but not separately accuracy-swept. |
