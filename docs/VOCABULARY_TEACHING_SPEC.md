...
| Vocabulary volume | ✅ | 2,006 unique curated senses (1,918 post-#54, +88 across sixteen M2 batches), slightly above the Core 1000 / Core 2000 target band, with every curated row assigned to a lesson |
...
1. **M2 sense split (the one open milestone — real authoring, not tagging).**
   90 lemmas have genuine multi-sense rows (§8). Sixteen batches so far:
