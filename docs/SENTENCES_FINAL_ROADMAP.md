...
| 2026-07-07 | Accuracy sweep batch 9 (s1601-s1800) | local branch | Swept s1601-s1800 for patternTag accuracy: removed clear false positives in location-e, direction-euro, and only-man; added missing present/past/formal ending tags; and bumped formal/honorific rows to band 5. |
