...
| Date | Box | PR | Notes |
|---|---|---|---|
| 2026-07-06 | Track D accuracy batch 002 (s0201-s0400) | this PR | Reviewed the next 200 sentence rows for high-risk pattern tags; corrected 38 rows across honorific `-세요` false positives, temporal `에`, `only-man`, counter-unit tagging, and tense overlap. See `docs/SENTENCES_TAG_ACCURACY_BATCH_002.md`. |
