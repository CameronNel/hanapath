...
| 2026-07-06 | Tag accuracy batch 005 (s0801-s1000) | PR #119 | Reviewed the fifth 200-row accuracy slice, correcting progressive `-고 있어요` false positives, temporal/dative `에` tags, missing tense/counter/time tags, and other clear closed-set tag mismatches. |
