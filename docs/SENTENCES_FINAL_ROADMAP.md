...
| 2026-07-17 | H2 batch 15 (s3211–s3250) | draft PR | **40 authored rows covering Business & Office Korean** (Bands 3-5) — workplace etiquette, presentations, meetings, reports, and emails. Utilizes polite-formal (하십시오체) and polite-informal (해요체) registers with honorifics. Foundation 0/0; 1 new lesson, zero ids removed; cache v399; edge-tts audio. All strict audits + foundation/app-shell + Chromium smoke pass. |
