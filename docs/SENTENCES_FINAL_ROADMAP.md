...
| 2026-07-06 | Tag accuracy batch 006 (s1001-s1200) | PR #120 | Reviewed the sixth 200-row accuracy slice, correcting progressive `-고 있어요` false positives, sequence-vs-cause `-아서/-어서`, dative `에`, counter/unit tags, and other clear closed-set tag mismatches. |
