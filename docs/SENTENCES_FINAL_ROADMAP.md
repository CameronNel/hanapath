...
| 2026-07-07 | Accuracy sweep batch 10 (s1801-s2000) | local branch | Swept s1801-s2000 for patternTag accuracy and band corrections: removed false location-e, direction-euro, and existence-itda tags; fixed past-polite/formal rows; and bumped the cache version for a reviewable static PWA deploy. |
