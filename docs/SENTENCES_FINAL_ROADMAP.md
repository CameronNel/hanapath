...
| 2026-07-17 | H2 batch 13 (s3021–s3180) | draft PR #286 | **160 authored rows across four packs**: requests/favors/permission (could-you, would-you-mind, may-I, lend/help), advice/suggestions/warnings (be-careful, you-should, dont-overdo-it, its-good-to), past experiences/storytelling (-(으)ㄴ 적이 있다, 그때, 어렸을 때, 처음으로), reactions/exclamations/nuance (really?, wow, congrats, what-a-relief, I-see, of-course). Bands 1-5, adds high-frequency interactional Korean. Foundation 0/0; 21 new lessons, zero ids removed; cache v397; offline mimic3 KSS audio. All strict audits + foundation/app-shell + Chromium smoke pass. |
