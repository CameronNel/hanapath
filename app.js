...
const CORRECT_SOUND_DEFS = [
  { name: "Chime Confirmation 1", desc: "A clean, retro-style confirmation chime.", url: "audio/sound_effects/correct/correct_1.wav" },
  { name: "Chime Confirmation 2", desc: "A bright, multi-tone confirmation bell.", url: "audio/sound_effects/correct/correct_2.wav" },
  { name: "Chime Confirmation 3", desc: "A fast, cute high-pitched chord.", url: "audio/sound_effects/correct/correct_3.wav" },
  { name: "Chime Confirmation 4", desc: "A soft, pleasant success chime.", url: "audio/sound_effects/correct/correct_4.wav" },
  { name: "Chirpy Rise 1", desc: "A bubbly ascending chirping chime.", url: "audio/sound_effects/correct/correct_5.wav" },
  { name: "Chirpy Rise 2", desc: "A fast rising digital feedback sweep.", url: "audio/sound_effects/correct/correct_6.wav" },
  { name: "Chirpy Rise 3", desc: "A cute sci-fi rising coin-like sound.", url: "audio/sound_effects/correct/correct_7.wav" },
  { name: "Chirpy Rise 4", desc: "A bright, motivating sweep up.", url: "audio/sound_effects/correct/correct_8.wav" },
  { name: "Chirpy Rise 5", desc: "A playful, bubbly retro game rise.", url: "audio/sound_effects/correct/correct_9.wav" },
  { name: "Bubble Pop Open 1", desc: "A clean, bubbly interface pop.", url: "audio/sound_effects/correct/correct_10.wav" },
  { name: "Bubble Pop Open 2", desc: "A slightly softer, hollow bubble pop.", url: "audio/sound_effects/correct/correct_11.wav" },
  { name: "Bubble Pop Open 3", desc: "A cute plop-plip double bubble sound.", url: "audio/sound_effects/correct/correct_12.wav" },
  { name: "Glass Ding 1", desc: "A high-pitched metallic glass chime.", url: "audio/sound_effects/correct/correct_13.wav" },
  { name: "Glass Ding 2", desc: "A clean, resonant glass ring.", url: "audio/sound_effects/correct/correct_14.wav" },
  { name: "Glass Ding 3", desc: "A soft, pleasant metallic bell hit.", url: "audio/sound_effects/correct/correct_15.wav" },
  { name: "Cute Click 1", desc: "A solid, tactile interface button click.", url: "audio/sound_effects/correct/correct_16.wav" },
  { name: "Cute Click 2", desc: "A quick, soft digital snap.", url: "audio/sound_effects/correct/correct_17.wav" },
  { name: "Cute Click 3", desc: "A high-pitched woodblock-like click.", url: "audio/sound_effects/correct/correct_18.wav" },
  { name: "Cute Click 4", desc: "A clean, sharp cursor select tap.", url: "audio/sound_effects/correct/correct_19.wav" },
  { name: "Cute Pluck 1", desc: "A fast, bouncy string-like pluck.", url: "audio/sound_effects/correct/correct_20.wav" }
];

const INCORRECT_SOUND_DEFS = [
  { name: "Soft Error Buzz 1", desc: "A dull, low-pitched interface error buzzer.", url: "audio/sound_effects/incorrect/incorrect_1.wav" },
  { name: "Soft Error Buzz 2", desc: "A slightly sharp, digital error buzzer.", url: "audio/sound_effects/incorrect/incorrect_2.wav" },
  { name: "Soft Error Buzz 3", desc: "A soft, double error beep.", url: "audio/sound_effects/incorrect/incorrect_3.wav" },
  { name: "Soft Error Buzz 4", desc: "A flat, hollow buzzer tone.", url: "audio/sound_effects/incorrect/incorrect_4.wav" },
  { name: "Soft Error Buzz 5", desc: "A clean warning indicator sound.", url: "audio/sound_effects/incorrect/incorrect_5.wav" },
  { name: "Soft Error Buzz 6", desc: "A short, sharp error alert click.", url: "audio/sound_effects/incorrect/incorrect_6.wav" },
  { name: "Soft Error Buzz 7", desc: "A deep, dull feedback buzz.", url: "audio/sound_effects/incorrect/incorrect_7.wav" },
  { name: "Soft Error Buzz 8", desc: "A classic retro game failure buzz.", url: "audio/sound_effects/incorrect/incorrect_8.wav" },
  { name: "Digital Glitch 1", desc: "A quick, textured digital error glitch.", url: "audio/sound_effects/incorrect/incorrect_9.wav" },
  { name: "Digital Glitch 2", desc: "A short, scratchy glitch click.", url: "audio/sound_effects/incorrect/incorrect_10.wav" },
  { name: "Digital Glitch 3", desc: "A classic sci-fi scanner error glitch.", url: "audio/sound_effects/incorrect/incorrect_11.wav" },
  { name: "Digital Glitch 4", desc: "A low, textured warning glitch.", url: "audio/sound_effects/incorrect/incorrect_12.wav" },
  { name: "Decline Swoosh 1", desc: "A soft descending swoosh.", url: "audio/sound_effects/incorrect/incorrect_13.wav" },
  { name: "Decline Swoosh 2", desc: "A quick falling feedback sweep.", url: "audio/sound_effects/incorrect/incorrect_14.wav" },
  { name: "Decline Swoosh 3", desc: "A smooth retro game decline slide.", url: "audio/sound_effects/incorrect/incorrect_15.wav" },
  { name: "Decline Swoosh 4", desc: "A low, deep pitch drop swoosh.", url: "audio/sound_effects/incorrect/incorrect_16.wav" },
  { name: "Cancel Tap 1", desc: "A soft cancellation tap.", url: "audio/sound_effects/incorrect/incorrect_17.wav" },
  { name: "Cancel Tap 2", desc: "A quick, hollow back button snap.", url: "audio/sound_effects/incorrect/incorrect_18.wav" },
  { name: "Cancel Tap 3", desc: "A flat cancellation block hit.", url: "audio/sound_effects/incorrect/incorrect_19.wav" },
  { name: "Cancel Tap 4", desc: "A deep, warning click.", url: "audio/sound_effects/incorrect/incorrect_20.wav" }
];
