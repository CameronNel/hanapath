...
const CORRECT_SOUND_DEFS = [
  { name: "Warm Marimba Rise", desc: "A beautiful rising arpeggio on a wooden marimba.", url: "audio/sound_effects/correct/correct_1.wav" },
  { name: "Acoustic Double Pop", desc: "A crisp, woody double pop.", url: "audio/sound_effects/correct/correct_2.wav" },
  { name: "Vibraphone Chime", desc: "A resonant vibraphone bell note.", url: "audio/sound_effects/correct/correct_3.wav" },
  { name: "Celestial Chord", desc: "A bright, magical major 7th chime chord.", url: "audio/sound_effects/correct/correct_4.wav" },
  { name: "Kalimba Arpeggio", desc: "A lovely thumb-piano arpeggio.", url: "audio/sound_effects/correct/correct_5.wav" },
  { name: "Bubblegum Pop (Single)", desc: "A clean, bubblegum pop.", url: "audio/sound_effects/correct/correct_6.wav" },
  { name: "Bubblegum Pop (Double)", desc: "A bouncy double bubblegum pop.", url: "audio/sound_effects/correct/correct_7.wav" },
  { name: "Water Drop Pop", desc: "A clean, organic water droplet sound.", url: "audio/sound_effects/correct/correct_8.wav" },
  { name: "Zen Singing Bowl", desc: "A peaceful, resonant singing bowl strike.", url: "audio/sound_effects/correct/correct_9.wav" },
  { name: "Wood Block Tap", desc: "A sharp, organic woody tap.", url: "audio/sound_effects/correct/correct_10.wav" },
  { name: "Acoustic Guitar Pluck", desc: "A warm nylon string pluck.", url: "audio/sound_effects/correct/correct_11.wav" },
  { name: "Vintage Rhodes Chord", desc: "A warm, vintage electric piano major 9th chord.", url: "audio/sound_effects/correct/correct_12.wav" },
  { name: "Morning Bird Chirp", desc: "A cute, warm double chirp.", url: "audio/sound_effects/correct/correct_13.wav" },
  { name: "Crystalline Glass Ping", desc: "A high, pure glass bell chime.", url: "audio/sound_effects/correct/correct_14.wav" },
  { name: "Harmonized Duo Chime", desc: "A clean chime harmonized in a minor third.", url: "audio/sound_effects/correct/correct_15.wav" },
  { name: "Soft Whistle Slide", desc: "A human-like warm whistle sweep.", url: "audio/sound_effects/correct/correct_16.wav" },
  { name: "Woodblock Double Tap", desc: "A cute high-to-low wood block bounce.", url: "audio/sound_effects/correct/correct_17.wav" },
  { name: "Rhodes Arpeggio Rise", desc: "A warm electric piano chord arpeggio.", url: "audio/sound_effects/correct/correct_18.wav" },
  { name: "Harp Cascade Run", desc: "A magical cascading harp run.", url: "audio/sound_effects/correct/correct_19.wav" },
  { name: "Gentle Brass Swell", desc: "A warm, soft synth brass swell.", url: "audio/sound_effects/correct/correct_20.wav" }
];
...
const INCORRECT_SOUND_DEFS = [
  ...
  { name: "Marimba Minor Drop", desc: "A gentle two-note minor fall on a marimba.", url: "audio/sound_effects/incorrect/incorrect_2.wav" },
  { name: "Muted Wood Block", desc: "A single flat, organic wooden tap.", url: "audio/sound_effects/incorrect/incorrect_3.wav" },
  { name: "Faint Rhodes Hum", desc: "A quiet, warm electric piano detuned warning hum.", url: "audio/sound_effects/incorrect/incorrect_4.wav" },
  { name: "Decline Swoosh", desc: "A soft, low-frequency pitch drop.", url: "audio/sound_effects/incorrect/incorrect_5.wav" },
  { name: "Soft Bubble Drop", desc: "A hollow bubble pop dropping in pitch.", url: "audio/sound_effects/incorrect/incorrect_6.wav" },
  { name: "Quiet Muted Tap", desc: "A dead, extremely quiet strike.", url: "audio/sound_effects/incorrect/incorrect_7.wav" },
  { name: "Bass Guitar Mute", desc: "A soft pluck of a low bass guitar note.", url: "audio/sound_effects/incorrect/incorrect_8.wav" },
  { name: "Sad Kalimba Duo", desc: "Two descending minor notes on a kalimba.", url: "audio/sound_effects/incorrect/incorrect_9.wav" },
  { name: "Muted Rhodes Drop", desc: "A muffled electric piano chord dropping.", url: "audio/sound_effects/incorrect/incorrect_10.wav" },
  { name: "Faint Double Buzz", desc: "Two very soft, low-frequency triangle beeps.", url: "audio/sound_effects/incorrect/incorrect_11.wav" },
  { name: "Faint Bass Swoosh", desc: "A soft, low-frequency slide down.", url: "audio/sound_effects/incorrect/incorrect_12.wav" },
  { name: "Hollow Plop Drop", desc: "A hollow, double wood block drop.", url: "audio/sound_effects/incorrect/incorrect_13.wav" },
  { name: "Muted Bell Strike", desc: "A muffled low-frequency bell sound.", url: "audio/sound_effects/incorrect/incorrect_14.wav" },
  { name: "Digital Slide Drop", desc: "A clean, low sine wave note sliding down.", url: "audio/sound_effects/incorrect/incorrect_15.wav" },
  { name: "Muted Heavy Thud", desc: "A soft physical thud with low-pass envelope.", url: "audio/sound_effects/incorrect/incorrect_16.wav" },
  { name: "Soft Disappointment", desc: "Two muted descending marimba notes.", url: "audio/sound_effects/incorrect/incorrect_17.wav" },
